...
const TestList = () => {
  ...
  const handleCheckChange = async (e, patient) => {
    ...
    const payload = { ...patient, isApproved: true };
  ...
  const CancelAppointment = async (e, patient) => {
    const patientId = patient._id;
          ...
          <TableBody>
            {patients?.map((ul, index) => (
              <TableRow key={ul._id}>
                ...
                <TableCell align="center">{ul.isVisited ? 'Visited' : ul.isCancel ? 'Cancel' : 'Pending'}</TableCell>
                <TableCell align="center">
                  {
                    <>
                      ...
                      />
                      <Button className="cursor-pointer" id="cancel" onClick={e => CancelAppointment(e, ul)}>
                        <CancelOutlined id="cancel" color="danger" />
                      </Button>
                    </>
                  }
                </TableCell>
