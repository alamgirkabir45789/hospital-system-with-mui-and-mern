...
const VisitedPatientListPage = () => {
  ...
  const getAllPatient = async () => {
    const res = await axios.get(`http://localhost:7000/api/appointment`, { params: { isVisited: true, isApproved: true } });
...
export default VisitedPatientListPage;
